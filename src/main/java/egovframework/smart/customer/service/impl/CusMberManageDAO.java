 ...
 * </pre>
 */
@Repository("cusMberManageDAO")
public class CusMberManageDAO extends EgovAbstractMapper{
	...
	public List<CusMberManageVO> selectMberList(CusMberDefaultVO userSearchVO){
        return (List<CusMberManageVO>) list("cusMberManageDAO.selectMberList", userSearchVO);
    }
    ...
    public int selectMberListTotCnt(CusMberDefaultVO userSearchVO) {
        return (Integer)selectOne("cusMberManageDAO.selectMberListTotCnt", userSearchVO);
    }
    ...
    public void deleteMber(String delId){
        delete("cusMberManageDAO.deleteMber_S", delId);
    }
     ...
     * @return String 등록결과
     */
    public int insertMber(CusMberManageVO cusMberManageVO){
        return insert("cusMberManageDAO.insertMber_S", cusMberManageVO);
    }
     ...
     */
    public CusMberManageVO selectMber(String mberId){
        return (CusMberManageVO) selectOne("cusMberManageDAO.selectMber_S", mberId);
    }
	...
	public List<?> selectStplat(String stplatId){
    	return list("cusMberManageDAO.selectStplat_S", stplatId);
    }
     ...
     */
    public void updatePassword(CusMberManageVO passVO) {
        update("cusMberManageDAO.updatePassword_S", passVO);
    }
     ...
     */
    public CusMberManageVO selectPassword(CusMberManageVO cusMberManageVO){
    	return (CusMberManageVO) selectOne("cusMberManageDAO.selectPassword_S", cusMberManageVO);
    }
