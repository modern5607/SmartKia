...
public class SmartCrmDAO extends EgovAbstractMapper{
    ...
    public int selectCrmListTotCnt(SmartCrmVO smartCrmVO) {
        return (Integer)selectOne("smartCrmDAO.selectCrmListTotCnt", smartCrmVO);
    }
//
//    /**
