							...
							<div id="contents" class="content">
								...
								<div class="location">
									<ul>
										...
										<li><a href="">공통코드등록</a></li>
									</ul>
								</div>
								<!--// Location -->

								<form:form modelAttribute="comCodeVO" name="comCodeVO"	action="${pageContext.request.contextPath}/mdm/InsertCommonGroupCode.do" method="post">

									<h2 class="tit_2">공통코드등록</h2>
									...
									<div class="board_view2">
										<table summary="일반회원 등록정보">
											...
											<tr>
												<td class="lb"><label for="groupcode">그룹코드</label> <span
													class="req">필수</span></td>
												<td><input name="groupcode" id="groupcode" class="f_txt w_350" title="그룹코드" type="text" value="" maxlength="60" /></td>
											</tr>
											<tr>
												<td class="lb"><label for="groupname">그룹코드명</label> <span
													class="req">필수</span></td>
												<td><input name="groupname" id="groupname" class="f_txt w_350" title="그룹코드명" type="text" value="" maxlength="60" /></td>
											</tr>
											<tr>
												<td class="lb"><label for="groupremark">비고</label></td>
												<td><input name="groupremark" id="groupremark" class="f_txt w_350" title="비고" type="text" value="" maxlength="60" /></td>
											</tr>
											<tr>
											...
											<tr>
												<td class="lb"><label for="GROUP_ORD">출력순서</label></td>
												<td><input type="number" id="GROUP_ORD" id="GROUP_ORD" class="f_txt w_350" title="비고" min="0"></td>
											</tr>
										</table>
									</div>
