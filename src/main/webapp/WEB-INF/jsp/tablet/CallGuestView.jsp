...
<body>
	<div class="popup POP_DUPID_CONF" style="background-color: white;">
		<form name="checkForm" action="<c:url value='/tablet/CallGuestView.do'/>">
			<div class="pop_inner">
				...
				<div class="pop_container">
					<p class="result"> 접수번호 <c:out value="${seq}" /> 의 고객님을 호출하시겠습니까?</p>
					<div class="btn_area al_c pt20">
						<a href="#LINK" class="btn btn_blue_46 w_100"
							onclick="CallGuest(); return false;">예</a>
							<a href="#LINK" class="btn btn_blue_46 w_100"
