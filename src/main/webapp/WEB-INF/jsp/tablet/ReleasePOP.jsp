...
<script type="text/javaScript" language="javascript">
	...
	function ReleaseRepair(){
        ...
        // console.log($("#notelist").val());
		 ...
		 document.SmartTabletVo.action = "<c:url value='/tablet/ReleaseRepair.do'/>";
		 //document.SmartTabletVo.submit();
		 
		 $.ajax({
	            type: "POST",
	            url: "ReleaseRepair.do",
...
<body>
	...
	<div class="popup POP_DUPID_CONF"
		...
		<form name="SmartTabletVo" id="SmartTabletVo" action="<c:url value='/tablet/ReleasePOP.do'/>" method="post" >
			...
			<div class="pop_inner" style="width: 100%;">
                ...
                <div class="board_view2" style="border-top: none;">
                    <table>
                        ...
                        <tr>
                            <td class="lb">출고담당자</td>
                            <td><input type="text" class="f_txtsmall w_100" placeholder="${logininfo[0].MBER_NM}" readonly></td>
                            <td class="lb">비고</td>
							<td><input type="text"  class="f_txtsmall w_200" name="remark" id="remark" placeholder="출고비고사항"></td>
                        </tr>
                    </table>
                </div>
                <div class="right_col"> 
                    <a href="#" class="btn btn_blue_46 w_100" onclick="ReleaseRepair()" style="margin-top: 10px;">출고처리</a>
				</div>
				</div>
		</form>
	</div>
